...
import { AbilityModifier, EffectInstance, EffectSpec, StatusModifier } from "@/shared/types";
...
export abstract class BaseCharacter extends Destroyable {
    ...
    /* ────────────────────── constructor ──────────────────────── */
    constructor(public readonly name: string, public readonly stats: StatsProvider, protected readonly defaultAbilityIds: string[] = [], protected statusModifiers: StatusModifier[] = []) {
        super();
        this._type = "PLAYER";
