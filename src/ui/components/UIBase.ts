...
export class UIBase extends GameBase {
    ...
    protected bindDomEvent(elementOrType: HTMLElement | string, typeOrHandler: string | EventListenerOrEventListenerObject, maybeHandler?: EventListenerOrEventListenerObject) {
        let el: HTMLElement;
        let type: string;
